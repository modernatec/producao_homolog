...
class Controller_Admin_Cronogramas extends Controller_Admin_Template {
	...
	{	
		$view = View::factory('admin/cronogramas/list')
	...
	*/
    ...
    public function action_getObjects($project_id, $ajax = null){
		...
		$this->auto_render = false;
		$view = View::factory('admin/cronogramas/table');
		$viewFiltros = View::factory('admin/cronogramas/filtros');
