...
class Controller_Admin_Planning extends Controller_Admin_Template {
	...
	{	
		$view = View::factory('admin/planning/list')
			->bind('message', $message);

		$view->projectList = ORM::factory('project')->where('status', '=', '1')->order_by('name', 'ASC')->find_all(); 
		$view->datas = $this->createDateRangeArray('2015-06-17', '2015-08-17');
