...
class Controller_Error extends Controller_Site_Template
{
	...
	public function before()
	{
		...
		if ( ! $this->request->is_initial())
		{
			...
			if ($requested_page = rawurldecode($this->request->param('origination')))
			{
    ...
    public function action_403()
    {
		...
		$this->template->keywords = 'not found, 403';
