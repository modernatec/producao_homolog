...
<div class="task_bar_item">
	<div class="icon_team">
		<a class="load"  href="<?=URL::base();?>admin/tasks/index/ajax/?to=<?=$user_task->to->id?>" rel="task_bar" data-panel="#content" data-refresh="true" title="<?=ucfirst($user_task->to->nome);?>">
			<img class='round_imgList<?=$user_task->to->team->color;?>' src='<?=URL::base();?><?=($user_task->to->foto)?($user_task->to->foto):('public/image/admin/default.png')?>' height="20" style='float:left;' alt="<?=ucfirst($user_task->to->nome);?>" />
