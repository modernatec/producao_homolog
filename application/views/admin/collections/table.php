		...
		<ul class="list_item">
			...
			<li>				
				...
				<a class="check" href="<?=URL::base().'admin/collections/edit/'.$collection->id;?>" rel="load-content" data-panel="#direita" title="Editar">
					...
					<span class="list_faixa round red"><img src="<?=URL::base()?>/public/image/admin/calendar2.png" > <?=Utils_Helper::data($collection->fechamento,'d/m/Y')?></span> &bullet; <?=$collection->segmento->name?>
				</a>
			</li>
			<?}?>
		</ul>
