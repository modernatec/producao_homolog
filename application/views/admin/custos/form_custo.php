	...
	<form name="frmCreateTask" id="frmCreateTask" action="<?=URL::base();?>admin/tasks/assign" method="post" class="form" enctype="multipart/form-data">
		...
		<dl>
		    ...
		    <div class="left">  
		        ...
		        <dd>
		            <select name="team_id" id="team_id" data-target="supplier_id" data-url="admin/custos/getSuppliers" class="populate round" >
	        ...
	        <div class="left">  
		        ...
		        <dd>
		            <select name="supplier_id" id="supplier_id" class="round" style="width:150px;">
		                <option value="0">selecione</option>
